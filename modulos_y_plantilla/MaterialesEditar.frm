VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} MaterialesEditar 
   Caption         =   "Servicios"
   ClientHeight    =   4620
   ClientLeft      =   108
   ClientTop       =   456
   ClientWidth     =   8772.001
   OleObjectBlob   =   "MaterialesEditar.frx":0000
   StartUpPosition =   1  'Centrar en propietario
End
Attribute VB_Name = "MaterialesEditar"
...
Private Sub Button_OK_Click()
    ...
    EscribirCosto "TablaF_Materiales", txtNombre, costo
    
    GuardarDatosMaestros "MATERIALES", txtNombre, ExtraerTextoAntesDelEspacio(ComboBoxTipoDeMedida), ComboBoxUnidadCosto, _
...
ManejarError:
    ManejadorError "MaterialesEditar.Button_OK_Click"
    On Error GoTo 0
...
Private Sub ButtonEliminar_Click()
    ...
    respuesta = MsgBox("¿Está seguro que desea eliminar '" & UCase(txtNombre) & "' de la lista de Materiales?", vbYesNo + vbQuestion, "Confirmar eliminación")
    If respuesta = vbYes Then
        Set tabla = ThisWorkbook.Sheets("MATERIALES").ListObjects("MaestroMateriales")
        EliminarFilasPorValorColumna txtNombre, "MATERIAL", tabla
        
        Set tabla = Nothing
        Hoja3.Cells(label_row, MaterialesEditar.label_column).Clear
        Hoja3.Cells(label_row, MaterialesEditar.label_column + 1).Clear
...
Private Sub ComboBoxTipoDeMedida_Change()
    ...
    LlenarComboBoxUnidadCostoUnidadCantidad ComboBoxTipoDeMedida.Value, "MATERIAL"
